...
class PlayGround:
    ...
    def play_game(self, start_state: np.array,
        buffer: ExperienceBuffer = None, n_steps: int = 1000):
    ...
    def reduce_exploration(self, init_value, final_value, decay_steps, epoch: int):
        for agent in self.agents:
            agent._explore_rate = linear_decay(init_value,final_value, decay_steps,epoch)
